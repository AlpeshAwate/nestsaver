    ...
    return (
        <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-md border border-slate-200 dark:border-slate-700 max-w-4xl mx-auto">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-slate-300">
                <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the Paisabridge application (the "Service") operated by us.</p>
                ...
                <section>
                    ...
                    <p>In no event shall Paisabridge, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
                </section>
                ...
                <section>
                    ...
                    <p>If you have any questions about these Terms, please contact us at: <a href="mailto:legal@paisabridge.com" className="text-emerald-600 dark:text-emerald-400 hover:underline">legal@paisabridge.com</a></p>
                </section>
            </div>
        </div>
    );
